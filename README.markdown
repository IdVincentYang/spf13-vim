...
```bash
    ...
    curl https://raw.githubusercontent.com/IdVincentYang/spf13-vim/3.0/spf13-vim.sh -L > spf13-vim.sh && sh spf13-vim.sh
```

If you have a bash-compatible shell you can run the script directly:
```bash

    sh <(curl https://raw.githubusercontent.com/IdVincentYang/spf13-vim/3.0/spf13-vim.sh  -L)
```
